...
public class BrandController {
    ...
    public Result<List<Brand>> findByBrand(@PathVariable("categoryid")Integer categoryid) {
        List<Brand> list = brandService.findByBrand(categoryid);
        return new Result<>(true, StatusCode.OK, "查询分类成功", list);
    }
