...
public class SpecController {
    ...
    public Result<List<Result>> findByCategoryId(@PathVariable("categoryid") Integer categoryid) {
    ...
    public Result<List<Map>> findSpecByCategoryName(@PathVariable("categoryName") String categoryName) {
        List<Map> mapList = specService.findBrandListByCategoryName(categoryName);
